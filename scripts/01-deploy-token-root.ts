...
async function main() {
  ...
  const initialSupplyTo   = new Address("0:5c0bb2eaf85f52a9d003aba4a390daa36163f7a44af717c76f7a757793f5c005")
  // Address of token owner (write your own)
  const rootOwner         = new Address("0:5c0bb2eaf85f52a9d003aba4a390daa36163f7a44af717c76f7a757793f5c005")
  // Name of the token     
